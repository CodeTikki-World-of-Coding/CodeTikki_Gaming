...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("UPDATE QuestionBank SET QuestionTitle = :questionTitle, Option1 = :option1, Option2 = :option2, Option3 = :option3, Option4 = :option4, CorrectAnswere = :correctAnswere WHERE QuestionId = :questionId");
